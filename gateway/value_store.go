...
func (ps *proxyValueStore) PutValue(context.Context, string, []byte, ...routing.Option) error {
	return routing.ErrNotSupported
}

func (ps *proxyValueStore) GetValue(ctx context.Context, k string, opts ...routing.Option) ([]byte, error) {
...
func (ps *proxyValueStore) SearchValue(ctx context.Context, k string, opts ...routing.Option) (<-chan []byte, error) {
	if !strings.HasPrefix(k, "/ipns/") {
		return nil, routing.ErrNotSupported
	}
...
func (ps *proxyValueStore) fetch(ctx context.Context, name ipns.Name) ([]byte, error) {
...
func (ps *proxyValueStore) getRandomGatewayURL() string {
