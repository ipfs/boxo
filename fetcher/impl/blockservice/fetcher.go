...
func (fc FetcherConfig) FetcherWithSession(ctx context.Context, s blockservice.BlockGetter) fetcher.Fetcher {
...
func blockOpener(ctx context.Context, bs blockservice.BlockGetter) ipld.BlockReadOpener {
