...
* `routing/http`:
  ...
  * added support for address and protocol filtering to the delegated routing client (including client side filtering for servers that don't support filtering.) ([IPIP-484](https://github.com/ipfs/specs/pull/484)) [#678](https://github.com/ipfs/boxo/pull/678)
