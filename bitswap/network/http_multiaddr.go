...
// ExtractHTTPAddressesFromPeer extracts all HTTP schema+host+port addresses as *url.URL from a peer.AddrInfo object.
func ExtractHTTPAddressesFromPeer(info peer.AddrInfo) []*url.URL {
