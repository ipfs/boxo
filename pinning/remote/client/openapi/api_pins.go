...
type apiPinsIdDeleteRequest struct {
	ctx        _context.Context
	apiService *PinsApiService
	id         string
}
...
/*
PinsIdDelete Remove pin object
Remove a pin object
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return apiPinsIdDeleteRequest
*/
func (a *PinsApiService) PinsIdDelete(ctx _context.Context, id string) apiPinsIdDeleteRequest {
	return apiPinsIdDeleteRequest{
		apiService: a,
		ctx:        ctx,
		id:         id,
...
*/
func (r apiPinsIdDeleteRequest) Execute() (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "PinsApiService.PinsIdDelete")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/pins/{id}"
...
type apiPinsIdGetRequest struct {
	ctx        _context.Context
	apiService *PinsApiService
	id         string
}
...
/*
PinsIdGet Get pin object
Get a pin object and its status
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return apiPinsIdGetRequest
*/
func (a *PinsApiService) PinsIdGet(ctx _context.Context, id string) apiPinsIdGetRequest {
	return apiPinsIdGetRequest{
		apiService: a,
		ctx:        ctx,
		id:         id,
...
Execute executes the request
 @return PinStatus
*/
func (r apiPinsIdGetRequest) Execute() (PinStatus, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "PinsApiService.PinsIdGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type apiPinsIdPostRequest struct {
	ctx        _context.Context
	apiService *PinsApiService
	id         string
	pin        *Pin
...
func (r apiPinsIdPostRequest) Pin(pin Pin) apiPinsIdPostRequest {
	r.pin = &pin
	return r
}

/*
PinsIdPost Modify pin object
Modify an existing pin object
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return apiPinsIdPostRequest
*/
func (a *PinsApiService) PinsIdPost(ctx _context.Context, id string) apiPinsIdPostRequest {
	return apiPinsIdPostRequest{
		apiService: a,
		ctx:        ctx,
		id:         id,
...
Execute executes the request
 @return PinStatus
*/
func (r apiPinsIdPostRequest) Execute() (PinStatus, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "PinsApiService.PinsIdPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
